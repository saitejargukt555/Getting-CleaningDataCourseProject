# R script for course project on Getting and Cleaning Data. 
 ...
 #--MERGING-- 
 #----------- 
    TrainingSet <- read.table("C:/Users/AR SOLUTIONS/Desktop/Getting and Cleaning Data Course Project/UCI HAR Dataset/train/X_train.txt") 
    TestSet <- read.table("C:/Users/AR SOLUTIONS/Desktop/Getting and Cleaning Data Course Project/UCI HAR Dataset/test/X_test.txt") 
    SubjectTrain <- read.table("C:/Users/AR SOLUTIONS/Desktop/Getting and Cleaning Data Course Project/UCI HAR Dataset/train/subject_train.txt") 
    SubjectTest <- read.table("C:/Users/AR SOLUTIONS/Desktop/Getting and Cleaning Data Course Project/UCI HAR Dataset/test/subject_test.txt") 
    TrainingLabels <- read.table("C:/Users/AR SOLUTIONS/Desktop/Getting and Cleaning Data Course Project/UCI HAR Dataset/train/y_train.txt") 
    Testlabels <- read.table("C:/Users/AR SOLUTIONS/Desktop/Getting and Cleaning Data Course Project/UCI HAR Dataset/test/y_test.txt") 
 ...
 #--EXTRACTION-- 
 #-------------- 
    AllFeatures <- read.table("C:/Users/AR SOLUTIONS/Desktop/Getting and Cleaning Data Course Project/UCI HAR Dataset/features.txt") 
 ...
 #--NAMING-- 
 #---------- 
    AllActivities <- read.table("C:/Users/AR SOLUTIONS/Desktop/Getting and Cleaning Data Course Project/UCI HAR Dataset/activity_labels.txt") 
    #----------For the activities 
 ...
 #---------------------------- 
    ...
    write.table(TidyAveragesData, "C:/Users/AR SOLUTIONS/Desktop/Getting&CleaningDataCourseProject/TidyAveragesData.txt") 
